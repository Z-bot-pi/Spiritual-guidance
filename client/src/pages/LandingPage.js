  ...
  return (
    <div className="landing-container" style={{ backgroundImage: `url('/the-importance-of-daily-meditation.png')`, backgroundSize: 'cover', backgroundPosition: 'center', height: '100vh' }}>
      ...
      <section className="intro">
        ...
        <p className="project-description">Spirituality is the foundation of life.In a world where achievements and dissapointments co-exist,balance is a necessity. Book your appointment with a spiritual guider,offload and get back rebooted</p>
        <Link to="/home">
